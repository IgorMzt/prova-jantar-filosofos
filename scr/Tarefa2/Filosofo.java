...
public class Filosofo extends Thread {
    ...
    private void comerOrdemInvertida() throws InterruptedException {
        logger.log("Filósofo " + id + " está tentando pegar o garfo DIREITO " + garfoDireito.getId() + " (ORDEM INVERTIDA)");
        synchronized (garfoDireito) {
            garfoDireito.pegar();
            logger.log("Filósofo " + id + " pegou o garfo DIREITO " + garfoDireito.getId());
